...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex font-sans text-slate-800">
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed lg:static inset-y-0 left-0 w-72 bg-white border-r border-slate-200 z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
      ...
      >
        <div className="h-16 flex items-center justify-between px-6 border-b border-slate-100 shrink-0">
          <div className="flex items-center gap-2 text-primary">
            ...
            <span className="font-bold text-xl tracking-tight">VN Doc OCR</span>
          </div>
          <button onClick={() => setIsMobileOpen(false)} className="lg:hidden text-slate-400 hover:text-slate-600">
            <X className="w-6 h-6" />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-8">
          <div>
            <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-4 px-4">Quy trình xử lý</div>
          ...
          <div>
            <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-4 px-4">Cấu hình</div>
            <nav className="space-y-1">
        ...
        <div className="p-4 border-t border-slate-100 shrink-0">
          <div className="flex items-center justify-between px-4 py-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
